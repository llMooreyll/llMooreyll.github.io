                ...
                (We = (function () {
                    ...
                    return (
                        ...
                        (t._getConfig = function (t) {
                            return (
                                'number' ==
                                typeof (t = l({}, this.constructor.Default, pe(this.element).data(), 'object' == typeof t && t ? t : {})).delay &&
                ...
                (Tn = (function () {
                    function n(t, e) {
                        ...
                        (this._element = t),
                            ...
                            (this._config = this._getConfig(e)),
                            (this._selector =
                                this._config.target + ' ' + gn + ',' + this._config.target + ' ' + mn + ',' + this._config.target + ' ' + vn),
                            (this._offsets = []),
                            (this._targets = []),
